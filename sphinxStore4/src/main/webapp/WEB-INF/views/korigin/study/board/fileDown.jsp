...
<% 
    ...
    String savePath = "upload"; // WebContent/upload // 위의 폴더는 상대경로이고 절대경로 기준의 진짜 경로를 구해와야한다.
    ...
    String sFilePath = sDownPath + "\\" + fileName; // ex)c:\\upload\\image.jpg
    ...
    byte[] temp = new byte[1024*1024*50]; // 50M

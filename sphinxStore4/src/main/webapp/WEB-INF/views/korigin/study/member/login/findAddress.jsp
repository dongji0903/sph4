...
function enterAddr() {
	opener.frm1.userAddr.value="("+post1.value+"-"+post2.value+")"+addr1.value+"("+addr2.value+")";
	self.close();
}
</script>
</head>
...
<span style="LINE-HEIGHT: 10%"><br></span>
<input id="addr2" size="40" name="addr2" placeholder="지번주소"><br>
<input type="button" value="확인" onclick="enterAddr()"><input type="button" value="취소" onclick="self.close()">
</body>
</html>